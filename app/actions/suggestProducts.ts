...
TIER GUIDANCE:
- "vintage" = genuine vintage items actually from this period (Etsy vintage listings described as "true vintage", "1920s vintage", "antique", items from specialist antique sellers). Rarer. Bias toward Etsy, network "etsy".
- "pre_owned" = actual secondhand/pre-owned vintage items not necessarily from the exact era but genuinely old (ThredUp, Depop, Poshmark, Etsy secondhand). Bias toward Etsy, network "etsy".
- "reproduction" = made today in period style (Etsy reproductions, costume-adjacent, modern makers working in period silhouettes, items described as "1920s style" or "flapper style"). Bias toward Etsy, network "etsy".
- "modern" = contemporary pieces that evoke the look without being period-styled (modern slip dress, current oxford shirt, mainstream retailer pieces). Bias toward Amazon/Nordstrom, network "amazon" or "nordstrom".
...
- "match_tier": one of "vintage", "pre_owned", "reproduction", "modern"
- "search_hint": 4–8 word search query to find this item

Bias the mix: 1–2 vintage, 1–2 pre_owned, 1–2 reproduction, 2–3 modern.
