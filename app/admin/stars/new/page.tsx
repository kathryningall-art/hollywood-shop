...
export default function NewStarPage() {
  ...
  function set(field: string, value: string) {
    setForm((prev) => {
      ...
      // Auto-generate slug from name if slug is still clean
  ...
  return (
    <div className="max-w-xl">
      <h1 className="font-serif text-navy text-2xl mb-8">Add Star</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Field label="Slug (URL)" required hint="Auto-generated from name — edit if needed">
          <input
            type="text"
            value={form.slug}
        ...
        <Field label="Hero Image Credit">
          <input
            ...
            className={input}
            placeholder="e.g. Richee / Paramount, public domain"
          />
        </Field>
        ...
        <Field label="Publicity Rights Notes">
          <textarea
            ...
            rows={3}
            className={input}
            placeholder="Notes on estate status, jurisdiction, etc."
          />
        </Field>
