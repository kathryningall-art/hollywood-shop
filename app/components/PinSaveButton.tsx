/**
 * Pinterest "Save" button overlaid on look hero images.
 *
 * Uses Pinterest's pin/create URL pattern — no external script needed.
...
interface PinSaveButtonProps {
  ...
  pageUrl: string;
  /** Absolute URL of the image to pin. */
  mediaUrl: string;
...
export default function PinSaveButton({
  ...
  return (
    <a
      ...
      "
    >
      {/* Pinterest 'P' mark — inline SVG so we don't depend on Pinterest's CDN. */}
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
